...
import { ClipboardCheck, CheckCircle2, XCircle, Clock, Award, Plus, Eye, FileCheck, X } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex" onClick={onClose}>
            ...
            >
                <div className="px-5 py-3 border-b border-slate-200 flex items-center justify-between bg-slate-50">
                    ...
                    <button onClick={onClose} className="inline-flex items-center justify-center h-8 w-8 rounded-md hover:bg-slate-200 text-slate-600"><X className="h-4 w-4" /></button>
                </div>
